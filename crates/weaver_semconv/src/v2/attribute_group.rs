...
pub struct InternalAttributeGroup {
    ...
    /// List of attributes that belong to this group
    #[serde(default)]
    #[serde(skip_serializing_if = "Vec::is_empty")]
    pub attributes: Vec<AttributeRef>,

    /// Which attribute groups this group includes
    #[serde(default)]
    #[serde(skip_serializing_if = "Vec::is_empty")]
    ...
    pub fn into_v1_group(self) -> GroupSpec {
        let res = match self {
            ...
            AttributeGroup::Public {
                ...
                prefix: Default::default(),
                extends: None,
                include_groups: common.include_groups,
                stability: None,
                deprecated: None,
                attributes: attributes
                    .into_iter()
        ...
        log::debug!(
            "Translated v2 attribute group {} into v1 group spec, visibility: {:?}",
            res.id,
            res.visibility
        );
